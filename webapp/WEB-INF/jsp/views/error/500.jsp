...
<title>KOSIGN WECAFE -- SERVER ERROR</title>
...
<!-- Waves-effect -->
<link href="${pageContext.request.contextPath}/css/waves-effect.css"
	rel="stylesheet">
...
<body>
	...
	<div class="wrapper-page">
		<div class="ex-page-content text-center">
			<h1>500</h1>
			<h2 class="font-light">Internal Server Error.</h2>
			<br>
			<p>
	...
	<script
		src="${pageContext.request.contextPath}/assets/jquery-detectmobile/detect.js"></script>
	<script
		src="${pageContext.request.contextPath}/assets/fastclick/fastclick.js"></script>
	<script
		src="${pageContext.request.contextPath}/assets/jquery-slimscroll/jquery.slimscroll.js"></script>
	<script
		src="${pageContext.request.contextPath}/assets/jquery-blockui/jquery.blockUI.js"></script>
