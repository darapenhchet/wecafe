								...
								<div class="panel-body">
									<div class=" form">
										<form class="cmxform form-horizontal tasi-form"
											id="frmProductAdd" method="POST"
											action="/admin/product/update">
											<div class="form-group ">
												<input type="hidden" id="productId" name="productId"
													type="text" value="${product.productId }" /> <label
													for="productname" class="control-label col-lg-2">Product
													Name *</label>
												<div class="col-lg-10">
											...
											<div class="form-group ">
												...
												<div class="col-lg-10">
													<input class="form-control " id="unitPrice"
														name="unitPrice" type="text" value="${product.unitPrice }"
														required="required">
												</div>
											</div>
											<div class="form-group ">
											...
											<div class="form-group ">
												...
												<div class="col-lg-10">
													<input class="form-control " id="salePrice"
														name="salePrice" type="text" value="${product.salePrice }"
														required="required">
												</div>
											</div>
											<div class="form-group ">
