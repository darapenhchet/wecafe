						...
						<ul class="nav navbar-nav navbar-right pull-right">
							...
							<li class="hidden-xs"><a href="#"
								class="right-bar-toggle waves-effect waves-light"><i
									class="md md-chat"></i></a></li>
							<li class="dropdown"><a href=""
								class="dropdown-toggle profile" data-toggle="dropdown"
								aria-expanded="true"><img src="images/avatar-1.jpg"
				...
				<div id="sidebar-menu">
					<ul>
						...
						<li><a href="calendar.html" class="waves-effect"><i
								class="md md-event"></i><span> Calendar </span></a></li>
						...
						<li class="has_sub"><a href="#" class="waves-effect active"><i
							...
							<ul class="list-unstyled">
								...
								<li class="active"><a href="form-uploads.html">Multiple
										File Upload</a></li>
