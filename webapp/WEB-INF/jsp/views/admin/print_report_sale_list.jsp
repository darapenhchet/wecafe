	...
	<div class="modal-dialog modal-lg" style="width: 80%">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Daily Sale List</h4>
				<small id="report_start_daily"></small> 
			</div>
			...
			<div class="col-md-10 form-horizontal" align="right">
				...
				<div class="col-md-3">
					<input class="form-control" readonly="readonly"
						id="allTotalAmount_print_daily" type="text">
				</div>
			</div> 
	...
	<div class="modal-dialog modal-lg" style="width: 80%">
		<div class="modal-content">
			<div class="modal-header">
				<!-- <button type="button" class="close hidden-print" data-dismiss="modal">&times;</button> -->
				<a href="javascrpt:;" class="btn btn-inverse waves-effect waves-light pull-right hidden-print" onclick="window.print();"><i class="fa fa-print"></i></a>
				<h4 class="modal-title">Weekly Sale List</h4>
				<small id="report_start_weekly"></small> - <small id="report_end_weekly"></small> 
			</div>
			<div class="modal-body"> 
				<div class="table-responsive"> 
					<table class="table table-hover table-bordered table-responsive"
			...
			<div class="col-md-10 form-horizontal" align="right">
				...
				<div class="col-md-3">
					<input class="form-control" readonly="readonly"
						id="allTotalAmount_print_weekly" type="text">
				</div>
			</div> 
				<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
			</div>
	...
	<div class="modal-dialog modal-lg" style="width: 80%">
		<div class="modal-content">
			<div class="modal-header">
				<!-- <button type="button" class="close hidden-print" data-dismiss="modal">&times;</button> -->
				<a href="javascrpt:;" class="btn btn-inverse waves-effect waves-light pull-right hidden-print" onclick="window.print();"><i class="fa fa-print"></i></a>
				<h4 class="modal-title">Monthly Sale List</h4>
				<small id="report_start_monthly"></small>  
			</div>
			<div class="modal-body"> 
				<div class="table-responsive"> 
					<table class="table table-hover table-bordered table-responsive"
			...
			<div class="col-md-10 form-horizontal" align="right">
				...
				<div class="col-md-3">
					<input class="form-control" readonly="readonly"
						id="allTotalAmount_print_monthly" type="text">
				</div>
			</div> 
				<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
			</div>
