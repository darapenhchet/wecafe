...
<body>
						...
						<div class=" form">
							<form class="cmxform form-horizontal tasi-form" id="signupForm"
								...
								<div class="form-group ">
									...
									<div class="col-lg-10">
										<input class="form-control " required="required"
											id="UnitPrice" name="Unit Pirce" type="text">
									</div>
								</div>
								<div class="form-group ">
	...
	<!-- From Request Stock -->
	<div id="request_stock" style="display: none;" style="width: 80%;">
				...
				.ready(
						function($) {
							...
							$(document)
									.on(
											"blur",
											"#productName ,#qty ,#UnitPrice ,#supplierName",
											function() {
